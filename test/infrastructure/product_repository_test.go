...
func TestGetAllProducts(t *testing.T) {
	...
	t.Run("GetAllProducts", func(t *testing.T) {
		actual_products := productRepository.GetAllProducts()
		assert.Equal(t, 4, len(actual_products))
		assert.Equal(t, expectedProducts, actual_products)
	})
	clear(ctx, dbPool)
}
...
func TestGetAllProductsByStore(t *testing.T) {
	...
	t.Run("GetAllProductsByStore", func(t *testing.T) {
		actual_products := productRepository.GetAllProductsByStore("ABC TECH")
		assert.Equal(t, 3, len(actual_products))
		assert.Equal(t, expectedProducts, actual_products)
	})
	clear(ctx, dbPool)
}

func TestGetAddProduct(t *testing.T) {
	expectedProducts := []domain.Product{
		{
			Id:       1,
			Name:     "Kupa",
...
func TestDeleteById(t *testing.T) {
	...
	t.Run("DeleteProductById", func(t *testing.T) {
		...
		_, err := productRepository.GetById(2)
		assert.Equal(t, "Product with id 2 not found", err.Error())
	})
...
func TestUpdatePrice(t *testing.T) {
	setup(ctx, dbPool)
	t.Run("TestUpdatePrice", func(t *testing.T) {
